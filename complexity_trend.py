...
os.chdir(dir)
analyze_command = f"python D:\\Development\\Tornhill\\maat-scripts\\miner\\git_complexity_trend.py --start {initial_commit} --end {final_commit} --file {filename} > {output}.csv"
